...
'Validating user ID
If user_ID_for_validation <>  "CDPOTTER" and _
	user_ID_for_validation <> "RAKALB" AND _
	user_ID_for_validation <> "MLDIETZ" _
...
'IF developer_mode = True THEN revs_month = DateAdd("M", -1, revs_month)  'uncomment this if you need to test in the current month +1 rather than testing for CM+2
...
DO
	...
	'msgbox CSR_mo & vbCr & recert_mo for testing purposes
